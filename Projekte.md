...
<meta name="description" content="Bewerbung um eine wissenschaftliche Projektstelle.">
  ...
  <div>
    ...
    <ul class="pages">
     ...
     <!-- <li><a href="/search/"><i class="fa fa-search"></i> Search</a></li>-->
      <li><a href="/Projekte/"><i class="fa fa-heartbeat"></i> Projekte</a></li>
      <li><a href="/Lehre/"><i class="fa fa-graduation-cap"></i> Lehre</a></li>
      <li><a href="/Anlagen/"><i class="fa fa-file-text"></i> Anlagen</a></li>
      <li><a href="/Kontakt/"><i class="fa fa-envelope"></i> Kontakt</a></li>

    </ul>

    <p class="links">
  <a href="https://www.linkedin.com/profile/preview?vpa=pub&locale=de_DE" target="_new"><i class="fa fa-linkedin"></i></a>
  <a href="http://www.twitter.com/nikaOk85" target="_new"><i class="fa fa-twitter"></i></a>
  
  <a href="https://github.com/BriGitBardot" target="_new"><i class="fa fa-github-alt"></i></a>
  <a href="http://stackoverflow.com/users/3616812/user3616812" target="_new"><i class="fa fa-stack-overflow"></i></a>
...
<div class="container-fluid single">
  <div class="row">
    ...
    <div itemscope itemtype="http://schema.org/Article" class="col-md-12 article">
      ...
      <h1 class="header" itemprop="name">Aktuelle Projekte</h1>
